...
urlpatterns = [
    ...
    path('cadastraalternativas/<projeto_id>/',
         views.cadastraalternativas,
         name='cadastraalternativas'),
    path('cadastracriterios/<projeto_id>/',
         views.cadastracriterios,
         name='cadastracriterios'),
